                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?php
                                                    $phoneInputValue = old('phone_number', $checkoutPhoneNumber);
                                                    $phoneLocalValue = preg_replace('/\D+/', '', (string) $phoneInputValue);

                                                    if (str_starts_with($phoneLocalValue, '255')) {
                                                        $phoneLocalValue = substr($phoneLocalValue, 3);
                                                    }

                                                    if (strlen($phoneLocalValue) === 10 && str_starts_with($phoneLocalValue, '0')) {
                                                        $phoneLocalValue = substr($phoneLocalValue, 1);
                                                    }
                                                ?>
                                                <div class="input-group input-group-lg">
                                                    ...
                                                    <input type="text" name="phone_number"
                                                        ...
                                                        value="<?php echo e($phoneLocalValue); ?>"
                                                        maxlength="9" inputmode="numeric" pattern="^[0-9]{9}$" required>
                                                </div>
                                            </div>
                                            <div class="col-12">
...
<?php echo $__env->make('layouts.shop', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\hngob\hidaya_fyp\resources\views/shop/checkout.blade.php ENDPATH**/ ?>