    ...
    <div class="p-3">
        ...
        <ul class="nav flex-column">
            <?php if(Auth::check() && Auth::user()->role === 'admin'): ?>
                ...
                <?php
                    $adminSettingsOpen = request()->is('admin/settings/header*') || request()->is('admin/settings/footer*') || request()->is('admin/settings/mail*') || request()->is('admin/settings/seller-permissions*');
                ?>
