...
<div class="container-fluid mt-2">
    ...
    <?php
        $groups = collect($components)->keys()->values();
    ?>
        ...
        <div class="panel-card-body">
            <form method="POST" action="<?php echo e(route('admin.settings.seller-permissions.bulk-update')); ?>">
                ...
                <div class="tab-content" id="permissionGroupsContent">
                    <?php $__currentLoopData = $components; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group => $groupComponents): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
