    ...
    <tr>
        ...
        <td>
            ...
            <?php if($order->payment_status): ?>
                <span class="badge text-capitalize <?php echo e($order->payment_status === 'paid' ? 'text-bg-success' : ($order->payment_status === 'failed' ? 'text-bg-danger' : 'text-bg-warning')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\hngob\hidaya_fyp\resources\views/customer/partials/order_rows.blade.php ENDPATH**/ ?>