...
<div class="container-fluid mt-2">
    ...
    <div class="row g-4">
        <div class="col-12">
            @include('admin.settings._nav', ['active' => 'orders'])
        </div>
        ...
        <div class="col-12">
            <div class="card panel-card">
                ...
                <div class="panel-card-body">
                    <form action="{{ route('admin.settings.orders.update') }}" method="POST" novalidate>
                        @csrf
                        @if ($errors->any())
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="order_auto_cancel_hours" id="order_auto_cancel_hours" value="{{ $settings['order_auto_cancel_hours'] ?? '24' }}" min="0" max="720">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="order_auto_cancel_minutes" id="order_auto_cancel_minutes" value="{{ $settings['order_auto_cancel_minutes'] ?? '0' }}" min="0" max="59">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="order_auto_cancel_seconds" id="order_auto_cancel_seconds" value="{{ $settings['order_auto_cancel_seconds'] ?? '0' }}" min="0" max="59">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <span id="timer-display">
                                        {{ ($settings['order_auto_cancel_hours'] ?? '24') }} hours,
                                        {{ ($settings['order_auto_cancel_minutes'] ?? '0') }} minutes,
                                        {{ ($settings['order_auto_cancel_seconds'] ?? '0') }} seconds
                                    </span>
                                </div>
                            </div>
                        </div>
