...
@section('styles')
<link rel="stylesheet" href="{{ asset('css/seller-product-media.css') }}">
@endsection
...
<div class="container-fluid mt-2 product-media-page"
     data-product-id="{{ $product->public_id }}"
        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <p class="page-subtitle mb-0">Manage images and videos for: <strong>{{ $product->name }}</strong></p>
                </div>
                <button type="button"
                        class="btn btn-outline-secondary themed-outline-btn"
                        data-spin-on-click
                        data-loading-text="Returning..."
                        onclick="window.location.href='{{ route('seller.products') }}'">
...
@push('scripts')
<script src="{{ asset('js/seller-product-media.js') }}"></script>
@endpush
