...
@section('styles')
<link rel="stylesheet" href="{{ asset('css/sellerorder.css') }}">
@endsection
                        ...
                        <div class="row g-3">
                            <div class="col-md-3">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control" placeholder="Search order number, customer, status..." value="{{ request('search') }}">
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-1">
                                <a href="{{ route('seller.orders') }}" class="btn btn-outline-secondary themed-outline-btn w-100">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody id="ordersTableBody">
                                @include('seller.partials.order_rows', ['orders' => $orders])
                            </tbody>
                        </table>
                    </div>
...
<script src="{{ asset('js/sellerorder.js') }}"></script>
@endpush
